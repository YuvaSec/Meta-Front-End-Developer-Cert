...
- HTTP (Hypertext Transfer Protocol) is the foundational protocol for transferring web resources like HTML documents and images between clients (browsers) and servers.
...
- while the response includes a **status code** and optional **message body**.
...
- *User-Agent* header informs the web server of the application that is making the request. It often includes the operating system (Windows, Mac, Linux), version and application vendor.
...
![[Gemini_Generated_Image_km5znukm5znukm5z.jpeg]]

- Common codes include **200 (OK)**, **404 (Not Found**), and **500 (Internal Server Error)**.

**Introduction to HTTPS**

- HTTPS is the secure version of HTTP, utilizing encryption to protect data during transmission.
- It ensures that sensitive information, like credit card details, is securely communicated between the client and server, indicated by the lock icon in the browser's URL bar.

# http request ![[http request.mp4]]
# http response ![[http response.mp4]]
# Client Errors ![[client Errors.mp4]]
# https ![[https.mp4]]
