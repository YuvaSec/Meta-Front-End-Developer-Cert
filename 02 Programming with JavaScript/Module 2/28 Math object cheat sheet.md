...
built-in number constants that exist on the Math object:
- **The PI number:**
	- Math.PI which is approximately 3.14159

- **Euler's number:**
	- Math.E which is approximately 2.718

- **The natural logarithm of 2:** 
	- Math.LN2 which is approximately 0.693
